...
except ImportError:  # transformers versions without native DINOv3 symbol
    DINOv3ViTModel = None
import numpy as np
...
class DinoV3FeatureExtractor:
    ...
    def extract_features(self, image: torch.Tensor) -> torch.Tensor:
        if hasattr(self.model, "embeddings") and hasattr(self.model.embeddings, "patch_embeddings"):
            image_dtype = self.model.embeddings.patch_embeddings.weight.dtype
        else:
