...
def render(
    ...
    if backend == "inria" and not HAS_INRIA_RASTERIZER:
        warnings.warn(
            "Requested backend 'inria' but diff_gaussian_rasterization is unavailable; "
            "falling back to backend 'gsplat'.",
            RuntimeWarning,
        )
        backend = "gsplat"
