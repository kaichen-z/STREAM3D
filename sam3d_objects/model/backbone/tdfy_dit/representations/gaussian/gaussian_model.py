...
class Gaussian:
    ...
    def save_ply(self, path):
        ...
        xyz = _to_numpy_float32(self.get_xyz)
        ...
        opacities = _to_numpy_float32(inverse_sigmoid(self.get_opacity))
        scale = _to_numpy_float32(torch.log(self.get_scaling))
        rotation = _to_numpy_float32(self._rotation + self.rots_bias[None, :])
